        ...
        <div className="rule-container">
            <div className="rule-title">
                ...
                <div className="rule-visibility">
                    <input onClick={toggleValid} type="checkbox" checked={rule.valid}/>
                </div>
                ...
                <div className="rule-body-wrapper">
                    ...
                    <div className="rule-controls">
                        <div className="rule-only-count">
                            <input onClick={toggleOnlyCount} type="checkbox" checked={rule.onlyCount}/>
                        </div>
                        <div className="rule-relations">
                            ...
                            <div className="rule-relations-wrapper">
                                {rule.relationOperations.map((operation, index) => <RelationCell index={index} operation={operation}></RelationCell>)}
                            </div>
                        </div>
                    </div>
                </div>
